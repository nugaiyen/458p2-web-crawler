...
For improvements, I should filter out my data further to avoid confusion about the importance of certain words, such as “video.” There are also many words that end with [A hat], which raises questions about why they appear so frequently. To improve future research, I should investigate the reason for this pattern and remove those terms and other filler words ("the", "is", "a") as necessary.

I was surprised to see Renton stand out so noticeably on the I-405 word cloud map. When I think of this interstate, I usually only think as far as Bellevue, but I-405 does connect to Renton and can be a faster route for others in the area. I was also surprised that the closures and traffic caused by I-5’s major construction did not have as large of an impact as I expected. From the begining of this lab, I thought that the word cloud would include more expressive words to convey emotions of traffic. 


### I-5 Word Cloud
![I-5](https://github.com/nugaiyen/458p2-web-crawler/blob/main/images/word-cloud-1(i5).png)
[I-5 CSV Link](https://github.com/nugaiyen/458p2-web-crawler/blob/main/assets/search-result-1(i5).csv)


### I-405 Word Cloud
![I-405](https://github.com/nugaiyen/458p2-web-crawler/blob/main/images/word-cloud-2(i405).png)
[I-405 CSV Link](https://github.com/nugaiyen/458p2-web-crawler/blob/main/assets/search-result-2(i405).csv)
